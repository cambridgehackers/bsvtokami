...
Declare Scope bk_scope.
Delimit Scope bk_scope with bk.

Notation "$$ v" := (ConstBit v%kami) (at level 5) : bk_scope.
Notation "$$ v" := (ConstBit v%kami) (at level 5) : kami_scope.
...
Notation "'MethodSig' name ( arg1T ) ( arg2T ) : retT" :=
  (Build_Attribute name {| arg := (Struct (STRUCT { "_1" :: arg1T; "_2" :: arg2T })); ret := retT |})
  (at level 0, name at level 0, arg1T at level 200, arg2T at level 200, retT at level 200).

Notation "'MethodSig' name ( arg1T ) ( arg2T ) ( arg3T ) : retT" :=
  (Build_Attribute name {| arg := (Struct (STRUCT { "_1" :: arg1T; "_2" :: arg2T; "_3" :: arg3T })); ret := retT |})
  (at level 0, name at level 0, arg1T at level 200, arg2T at level 200, arg3T at level 200, retT at level 200).

Notation "'MethodSig' name ( arg1T ) ( arg2T ) ( arg3T ) ( arg4T ) : retT" :=
  (Build_Attribute name {| arg := (Struct (STRUCT { "_1" :: arg1T; "_2" :: arg2T; "_3" :: arg3T; "_4" :: arg4T })); ret := retT |})
  (at level 0, name at level 0, arg1T at level 200, arg2T at level 200, arg3T at level 200, arg4T at level 200, retT at level 200).

Notation "'MethodSig' name ( arg1T ) ( arg2T ) ( arg3T ) ( arg4T ) ( arg5T ) : retT" :=
  (Build_Attribute name {| arg := (Struct (STRUCT { "_1" :: arg1T; "_2" :: arg2T; "_3" :: arg3T; "_4" :: arg4T; "_5" :: arg5T })); ret := retT |})
  (at level 0, name at level 0, arg1T at level 200, arg2T at level 200, arg3T at level 200, arg4T at level 200, arg5T at level 200, retT at level 200).

Notation "'MethodSig' name ( arg1T ) ( arg2T ) ( arg3T ) ( arg4T ) ( arg5T ) ( arg6T ) : retT" :=
  (Build_Attribute name {| arg := (Struct (STRUCT { "_1" :: arg1T; "_2" :: arg2T; "_3" :: arg3T; "_4" :: arg4T; "_5" :: arg5T; "_6" :: arg6T })); ret := retT |})
  (at level 0, name at level 0, arg1T at level 200, arg2T at level 200, arg3T at level 200, arg4T at level 200, arg5T at level 200, arg6T at level 200, retT at level 200).
...
Notation "'Call' name : t <- meth ( arg1 ) ( arg2 ) ; cont " :=
  (let arg := STRUCT { ("_1" ::= arg1)%init ; ("_2" ::= arg2)%init } in
...
Notation "'Call' name : t <- meth ( arg1 ) ( arg2 ) ( arg3 ) ; cont " :=
  (let arg := STRUCT { ("_1" ::= arg1)%init ; ("_2" ::= arg2)%init ; ("_3" ::= arg3)%init } in
  (MCall (lretT := t) (attrName meth) (attrType meth) arg%kami_expr (fun name => cont)))
    (at level 12, right associativity, name at level 0, meth at level 0) : kami_action_scope.
							   
Notation "'Call' name : t <- meth ( arg1 ) ( arg2 ) ( arg3 ) ( arg4 ) ; cont " :=
  (let arg := STRUCT { ("_1" ::= arg1)%init ; ("_2" :: arg2)%init ; ("_3" ::= arg3)%init ; ("_4" ::= arg4)%init } in
  (MCall (lretT := t) (attrName meth) (attrType meth) arg%kami_expr (fun name => cont)))
    (at level 12, right associativity, name at level 0, meth at level 0) : kami_action_scope.
							   
Notation "'Call' name : t <- meth ( arg1 ) ( arg2 ) ( arg3 ) ( arg4 ) ( arg5 ) ; cont " :=
 (let arg := STRUCT { ("_1" ::= arg1)%init ; ("_2" :: arg2)%init ; ("_3" ::= arg3)%init ; ("_4" ::= arg4)%init ; ("_5" ::= arg5 )%init } in
  (MCall (lretT := t) (attrName meth) (attrType meth) arg%kami_expr (fun name => cont)))
    (at level 12, right associativity, name at level 0, meth at level 0) : kami_action_scope.

Notation "'Call' name : t <- meth ( arg1 ) ( arg2 ) ( arg3 ) ( arg4 ) ( arg5 ) ( arg6 ) ; cont " :=
  (let arg := STRUCT { ("_1" ::= arg1)%init ; ("_2" :: arg2)%init ; ("_3" ::= arg3)%init ; ("_4" ::= arg4)%init ; ("_5" ::= arg5 )%init ; ("_6" ::= arg6 )%init } in
  (MCall (lretT := t) (attrName meth) (attrType meth) arg%kami_expr (fun name => cont)))
    (at level 12, right associativity, name at level 0, meth at level 0) : kami_action_scope.
...
Module module'fromMaybe.
    ...
    Variable data_t : Kind.
    Variable instancePrefix: string.
    Definition Modules'fromMaybe: Modules := (MODULE {
